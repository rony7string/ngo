			...
			<table id="example" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn-sm btn-warning" href="accounts/mr_save/<?php echo $value['id']; ?>"><i class="ion-edit"></i> Edit</a>
							<a class="btn-sm btn-danger del" href="accounts/mr_delete/<?php echo $value['id']; ?>"><i class="ion-trash-b"></i> Delete</a>
						</td>
					</tr>
					<?php
				endforeach;
