		...
		<section class="invoice">
			...
			<div class="row invoice-info">
				<div class="col-sm-4 invoice-col">
					<h4>Payment Receipt # <?php echo $details['payment_no']; ?></h4>
					<h4>Date: <?php echo date('jS F Y ', strtotime($details['payment_date'])); ?></h4>
				...
				<!-- /.col -->
				<div class="col-sm-4 invoice-col">
					<h4>Supplier Name: <?php echo $supplier['name']; ?></h4>
					<h4>Phone No: <?php echo $supplier['phone_no']; ?></h4>
